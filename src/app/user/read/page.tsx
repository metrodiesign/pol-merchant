...
import type { MerchantUserStatus } from "@/types/user";
import { EditPageHeader } from "@/components/shared/edit-page-header";
import { MerchantUserEditProfileCard } from "@/components/user/edit-profile-card";
  ...
  return (
    <>
      <EditPageHeader
        ...
        backHref="/user/list"
        breadcrumbs={[
          { label: "ตัวแทน/นายหน้า", href: "/user/list" },
          { label: "สมชาย ใจดี" },
        ]}
        actions={
