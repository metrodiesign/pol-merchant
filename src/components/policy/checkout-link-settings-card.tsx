      ...
      {options.map((o) => {
        ...
        return (
          <button
            ...
            className={
              "h-9 rounded-full border px-4 text-base font-semibold transition-colors " +
              (active
...
const labelCls = "mb-2 block text-base font-semibold text-grey-700";
    ...
    <div className={"rounded-xl border border-[var(--divider)]" + (disabled ? " opacity-60" : "")}>
      ...
      >
        ...
        <span className="min-w-0">
          ...
          <span className="block truncate text-base text-grey-500">
