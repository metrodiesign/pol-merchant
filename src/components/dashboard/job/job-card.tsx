      ...
      {open && (
        ...
        >
          <Link
            ...
            className="flex items-center gap-2 px-3 py-1.5 text-base text-grey-800 hover:bg-grey-100"
            role="menuitem"
          ...
          <button
            type="button"
            className="flex w-full items-center gap-2 px-3 py-1.5 text-base text-error hover:bg-grey-100"
            role="menuitem"
            onClick={() => setOpen(false)}
          >
    ...
    >
      ...
      <div className="p-6 pb-4">
        ...
        <Link
          ...
          className="mb-0.5 block text-base font-semibold leading-snug text-grey-800 hover:underline"
        >
          {job.title}
        </Link>
        ...
        {/* candidates */}
        <p className="mt-3 flex items-center gap-1 text-base font-semibold text-success-dark">
      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-3 p-6">
        <div className="flex items-center gap-1.5 text-base text-grey-500">
