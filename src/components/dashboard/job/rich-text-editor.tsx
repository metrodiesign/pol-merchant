    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-0.5 border-b border-grey-200 px-2 py-1.5">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-md px-2 py-1 text-base font-medium text-grey-800 hover:bg-[rgba(145,158,171,0.08)]"
        >
      ...
      <div
        ...
        className="min-h-[160px] px-4 py-3 text-base text-grey-800 outline-none empty:before:text-grey-400 empty:before:content-[attr(data-placeholder)]"
      />
    </div>
  );
}
