...
function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="mb-2 text-base font-semibold leading-[22px] text-grey-800">{children}</p>
  );
}
...
function TextInput({
  ...
  return (
    <input
      ...
      className="h-14 w-full rounded-control border border-[var(--divider)] bg-transparent px-3.5 text-base text-grey-800 placeholder:text-grey-400 outline-none focus:border-grey-800 focus:ring-1 focus:ring-inset focus:ring-grey-800"
    />
  );
}
...
function CheckboxItem({
  ...
  return (
    <label className="flex cursor-pointer items-center gap-2 text-base text-grey-700">
      <span
        className={cn(
  ...
  return (
    <Select value={value} onValueChange={(v) => onChange(v ?? "")}>
      <SelectTrigger
        ...
        className="h-14 w-full text-base text-grey-800"
      >
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="flex-1 text-base text-grey-400">{placeholder}</span>
        ...
        <div className="absolute left-0 right-0 top-full z-50 mt-1 max-h-52 overflow-y-auto rounded-xl bg-card py-1 shadow-[0_0_2px_rgba(145,158,171,0.24),-20px_20px_40px_-4px_rgba(145,158,171,0.24)]">
          {options.map((opt) => (
            <button
              ...
              onClick={() => toggle(opt)}
              className={cn(
                "flex w-full items-center px-4 py-2 text-base transition-colors hover:bg-grey-100",
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="flex-1 text-base text-grey-400">+ Locations</span>
        <svg className="size-4 shrink-0 text-grey-400" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="absolute left-0 right-0 top-full z-50 mt-1 max-h-52 overflow-y-auto rounded-xl bg-card py-1 shadow-[0_0_2px_rgba(145,158,171,0.24),-20px_20px_40px_-4px_rgba(145,158,171,0.24)]">
          {JOB_LOCATIONS.map((loc) => (
            <button
              ...
              className={cn(
                "flex w-full items-center gap-2 px-4 py-2 text-base transition-colors hover:bg-grey-100",
  ...
  return (
    <div className="relative flex h-14 w-full items-center rounded-control border border-[var(--divider)] bg-transparent px-3.5 focus-within:border-grey-800">
      <input
        ...
        className="flex-1 bg-transparent text-base text-grey-800 placeholder:text-grey-400 outline-none"
      />
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        {(["Hourly", "Custom"] as SalaryMode[]).map((m) => (
          ...
          >
            ...
            <span className="text-base font-semibold text-grey-800">{m}</span>
          </button>
        ))}
      </div>
      ...
      <div className="flex h-14 items-center rounded-control border border-[var(--divider)] bg-transparent px-3.5 focus-within:border-grey-800">
        <span className="mr-2 text-base text-grey-500">$</span>
        <input
          type="text"
          value={amount}
          ...
          className="flex-1 bg-transparent text-base text-grey-800 placeholder:text-grey-400 outline-none disabled:opacity-40"
        />
      </div>
      ...
      <label className="flex items-center gap-3 cursor-pointer">
        ...
        />
        <span className="text-base text-grey-700">Salary is negotiable</span>
      </label>
    </div>
  );
}
    ...
    <form onSubmit={handleSubmit} className="mx-auto max-w-[720px] space-y-10">
      ...
      <div className="flex items-center justify-between">
        <label className="flex cursor-pointer items-center gap-3">
          ...
          />
          <span className="text-base font-semibold text-grey-800">Publish</span>
        </label>

        <button
          type="submit"
          className="rounded-control bg-foreground h-12 px-4 text-base font-semibold text-card transition-opacity hover:opacity-90"
        >
