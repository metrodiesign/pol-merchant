  ...
  return (
    <div className="flex items-center gap-3 border-b border-[rgba(145,158,171,0.2)] px-4 py-3">
      ...
      <div className="flex-1 min-w-0">
        <p className="truncate text-base font-semibold leading-[22px] text-grey-800">{displayName}</p>
        <p className={cn("text-base leading-5", contact.online ? "text-success" : "text-grey-400")}>
