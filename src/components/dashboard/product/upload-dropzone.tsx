        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={removeAll}
              className="text-base font-semibold text-grey-600 transition-colors hover:text-error"
            >
              Remove All
            </button>
            <button
              type="button"
              onClick={() => inputRef.current?.click()}
              className="flex items-center gap-1.5 rounded-lg bg-grey-800 px-3 py-1.5 text-base font-semibold text-white transition-colors hover:bg-grey-900"
            >
