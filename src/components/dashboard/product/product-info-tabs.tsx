        ...
        <div role="tablist" className="flex gap-0">
          {TABS.map((tab) => (
            <button
              ...
              className={cn(
                "h-12 px-5 text-base transition-colors",
                activeTab === tab
      ...
      <div className="p-6">
        {activeTab === "Description" && (
          <div className="space-y-6">
            {/* Specifications */}
            <section>
              <h6 className="mb-3 text-base font-semibold text-foreground">
                Specifications
              </h6>
              <div className="space-y-0">
                {SPECS.map(({ key, value }) => (
                  <div
                    key={key}
                    className="grid grid-cols-[160px_1fr] border-b border-[var(--divider)] py-2 text-base last:border-0"
                  >
            ...
            <section>
              ...
              <ul className="space-y-1.5">
                {PRODUCT_DETAILS.map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-2 text-base text-grey-600"
                  >
        ...
        {activeTab === "Reviews (8)" && (
          <div className="py-8 text-center text-base text-grey-500">
