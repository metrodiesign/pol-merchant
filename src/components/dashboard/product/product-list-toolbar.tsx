        ...
        <div className="flex flex-1 items-center gap-0.5">
          {ACTION_BUTTONS.map(({ Icon, label }) => (
            <button
              key={label}
              type="button"
              className="flex h-[30px] items-center gap-1.5 rounded-lg px-2 text-base font-semibold text-grey-800 transition-colors duration-[250ms] hover:bg-[var(--action-hover)]"
            >
