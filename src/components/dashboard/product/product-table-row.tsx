...
export function ProductTableRow({
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <span className="block text-base text-grey-600">
              {product.category}
            </span>
          </div>
        </div>
      ...
      {/* Create at */}
      <td className="px-4 py-4">
        <p className="text-base text-foreground">{product.createdAt}</p>
        <p className="text-base text-grey-500">{product.createdTime}</p>
      </td>
