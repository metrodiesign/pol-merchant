  ...
  return (
    ...
    >
      ...
      <div className="flex h-8 items-center gap-2">
        ...
        <span
          className="flex h-5 min-w-[20px] items-center justify-center rounded-md px-1.5 text-base font-semibold leading-none text-grey-600"
        ...
        {isEditingName ? (
          <input
            ...
            className="min-w-0 flex-1 rounded bg-transparent px-1 text-base font-semibold text-grey-800 outline-none ring-1 ring-primary focus:ring-2"
            autoFocus
          ...
          <button
            ...
            className="min-w-0 flex-1 truncate text-left text-base font-semibold text-grey-800 hover:text-grey-600"
