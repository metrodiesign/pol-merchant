        ...
        {newsItems.map((item, i) => (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className="text-base font-semibold text-grey-800 hover:underline line-clamp-2">
                {item.title}
              </p>
              <p className="mt-0.5 line-clamp-2 text-base text-grey-500">
                {item.description}
              </p>
            </div>
            <span className="shrink-0 pt-0.5 text-base text-grey-500 whitespace-nowrap">
              {item.postedAt}
            </span>
          </li>
        ))}
