...
export function RoleToggle({ defaultRole = "admin" }: RoleToggleProps) {
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      <span className="text-base font-semibold text-grey-800">My role:</span>
        ...
        {(["admin", "user"] as const).map((r) => {
          ...
          return (
            <button
              ...
              onClick={() => setRole(r)}
              className={cn(
                "rounded-[8px] px-1 py-[5px] text-base font-semibold capitalize leading-5 transition-colors",
                isActive
