      ...
      <DialogContent key={formKey} className="max-w-md" showCloseButton>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label id={titleId} className="text-base font-medium text-grey-700">Title</label>
            <Input
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label id="allDay" className="text-base text-grey-700">All day</label>
          </div>

          {/* Start date */}
          <div className="flex flex-col gap-1.5">
            <label id={startId} className="text-base font-medium text-grey-700">Start date</label>
            <Input
          ...
          {/* End date */}
          <div className="flex flex-col gap-1.5">
            <label id={endId} className="text-base font-medium text-grey-700">End date</label>
            <Input
          ...
          {/* Color picker */}
          <div className="flex flex-col gap-1.5">
            <label className="text-base font-medium text-grey-700">Color</label>
          ...
          {/* Description */}
          <div className="flex flex-col gap-1.5">
            <label id={descriptionId} className="text-base font-medium text-grey-700">Description</label>
            <textarea
              ...
              className="w-full rounded-lg border border-grey-300 bg-transparent px-3.5 py-2 text-base text-foreground transition-colors outline-0 placeholder:text-grey-500 focus:border-grey-800 resize-none"
            />
          </div>
