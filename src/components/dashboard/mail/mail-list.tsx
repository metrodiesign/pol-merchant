      ...
      <div className="p-3">
        <div className="relative">
          ...
          <input
            ...
            className="h-10 w-full rounded-lg border border-grey-300 bg-transparent pl-9 pr-3.5 text-base text-foreground placeholder:text-grey-400 focus:border-grey-600 focus:outline-none"
          />
        </div>
      </div>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-1">
                  ...
                  <span className="shrink-0 text-base text-grey-400">{msg.relativeTime}</span>
                </div>
                <p className="truncate text-base text-grey-500">{msg.preview}</p>
              </div>
            </button>
          );
        })}
