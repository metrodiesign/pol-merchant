          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate text-base font-semibold text-grey-800">
                  {product.name}
                </p>
                <div className="mt-0.5 flex items-center gap-1.5">
                  {product.priceSale && (
                    <span className="text-base text-grey-400 line-through">
                      {product.priceSale}
                    </span>
                  )}
              ...
              <div className="flex shrink-0 items-center gap-0.5">
                ...
                {extraCount > 0 && (
                  <span className="ml-0.5 text-base font-medium text-grey-500">
                    +{extraCount}
                  </span>
                )}
              </div>
