    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden px-6 pb-4 pt-6">
        ...
        <div className="mb-4 flex items-center gap-2">
          ...
          <span className="text-base text-grey-500">{post.date}</span>
        </div>

        {/* Title */}
        <Link
          href="/minimals/post/details"
          className="mb-2 line-clamp-2 text-base font-semibold leading-[1.5] text-grey-800 transition-colors hover:underline"
        >
          {post.title}
        </Link>

        {/* Description */}
        <p className="line-clamp-2 flex-1 text-base leading-[1.7] text-grey-500">
          {post.description}
        </p>

        {/* Footer stats */}
        <div className="mt-auto flex items-center gap-4 pt-4 sm:pt-2">
          <span className="flex items-center gap-1 text-base text-grey-500">
