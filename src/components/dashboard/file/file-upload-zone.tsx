...
export function FileUploadZone() {
  return (
    <div className="flex flex-col items-center gap-2 rounded-xl border border-dashed border-grey-300 px-4 py-6">
      ...
      <p className="text-base font-semibold text-grey-700">Upload file</p>
      <div className="flex items-center gap-2">
        <label className="cursor-pointer">
          <span className="rounded-md border border-grey-300 px-3 py-1.5 text-base font-medium text-grey-700 hover:bg-grey-100">
            Choose Files
          </span>
          <input type="file" className="sr-only" multiple />
        </label>
        <span className="text-base text-grey-400">No file chosen</span>
      </div>
    </div>
  );
}
