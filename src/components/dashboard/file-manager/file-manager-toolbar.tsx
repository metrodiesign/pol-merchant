  ...
  return (
    <div className="flex flex-col gap-3 py-5 sm:flex-row sm:items-stretch sm:gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        <span className="select-none text-base font-medium text-grey-800">Date</span>
        <div className="flex flex-1 items-center">
          <button
            type="button"
            className="flex h-12 min-w-[140px] items-center gap-1.5 rounded-control border border-[var(--divider)] px-3.5 text-base font-semibold text-foreground transition-colors hover:bg-[var(--action-hover)]"
          >
            Select date
      ...
      {/* All type */}
      <div className="flex flex-col gap-1.5">
        <span className="select-none text-base font-medium text-grey-800">Type</span>
        <div className="flex flex-1 items-center">
          <button
            type="button"
            className="flex h-12 min-w-[120px] items-center gap-1.5 rounded-control border border-[var(--divider)] px-3.5 text-base font-semibold text-foreground transition-colors hover:bg-[var(--action-hover)]"
          >
            All type
            <ChevronDown className="size-4 text-grey-500" />
          </button>
      ...
      {/* View toggle */}
      <div className="flex flex-col gap-1.5">
        <span className="select-none text-base font-medium text-grey-800">View</span>
        <div className="flex flex-1 items-center">
