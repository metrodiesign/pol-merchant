...
import { validateRoleForm } from "@/lib/role/permissions";
...
/** หน้าแก้ไขบทบาทแบบเต็มหน้า (route แยก /role/edit). code read-only (REQ-7.3). UI-shell. */
export function RoleEditView({ role }: RoleEditViewProps) {
  ...
  function handleSaveConfirm() {
    ...
    router.push(`/role/list?toast=${encodeURIComponent(toast)}`);
  }
