// validation ฟอร์ม level — pure function คืน {field: message}, ว่าง = ผ่าน
...
export interface LevelFormInput {
  code: string;
  name: string;
}

export type LevelFormMode = "create" | "edit";

const CODE_PATTERN = /^[a-z0-9_]+$/;
const CODE_MAX = 64;
const NAME_MAX = 200;

export function validateLevelForm(
